...
CREATE OR REPLACE FUNCTION admin_login(username admin.username%type, password admin.password%type)
return number --return 0 if doesn't exist, return id if the admin exists:
is
...
--start from here
insert into department(dept_name,university_id) values('CSE',210);
insert into department(dept_name,university_id) values(302,'EEE',210);
insert into department(dept_name,university_id) values(303,'CSE',220);
insert into department(id,dept_name,university_id) values(304,'EEE',220);
insert into department(id,dept_name,university_id) values(305,'CSE',230);
insert into department(id,dept_name,university_id) values(306,'EEE',230);
insert into department(id,dept_name,university_id) values(308,'EEE',240);
insert into department(id,dept_name,university_id) values(309,'CSE',240);
insert into department(id,dept_name,university_id) values(310,'EEE',250);
insert into department(id,dept_name,university_id) values(310,'EEE',250);
...
insert into faculty(id,name,email,phone,dept_id) values(1,'Oshim Banerjee','oshim@gmail.com','01655543234',10);
insert into faculty(id,name,email,phone,dept_id) values(2,'Tanvir Khan','tanvir@gmail.com','01612343234',10);
...
insert into faculty(id,name,email,phone,dept_id) values(5,'Jesmin Nahar','jesmin@gmail.com','01933555433',40);
...
insert into student(id,name,email,phone,dept_id,admitted_year) values(35065,'Sizan','sizan@gmail.com','01793862457',10,2017);
insert into student(id,name,email,phone,dept_id,admitted_year) values(35066,'Rezwan','rezwan@gmail.com','01521166553',10,2017);
insert into student(id,name,email,phone,dept_id,admitted_year) values(35067,'Mahtab','mahtab@gmail.com','01734562342',10,2017);
insert into student(id,name,email,phone,dept_id,admitted_year) values(35068,'Rahil','rahil@gmail.com','01976862342',20,2017);
insert into student(id,name,email,phone,dept_id,admitted_year) values(35070,'Mobin','mobin@gmail.com','01623338817',20,2017);
insert into student(id,name,email,phone,dept_id,admitted_year) values(35071,'Asif','asif@gmail.com','01733220099',20,2017);
insert into student(id,name,email,phone,dept_id,admitted_year) values(35072,'Nabil','nabil@gmail.com','01734562311',30,2016);
insert into student(id,name,email,phone,dept_id,admitted_year) values(30001,'Towsif','towsif@gmail.com','01734561232',30,2015);
insert into student(id,name,email,phone,dept_id,admitted_year) values(30012,'Niloy','niloy@gmail.com','01734565435',30,2018);
insert into student(id,name,email,phone,dept_id,admitted_year) values(40100,'Minar','minar@gmail.com','01734561232',40,2017);
insert into student(id,name,email,phone,dept_id,admitted_year) values(40101,'Sajjad','sajjad@gmail.com','01734513232',40,2016);
...
insert into project_student values(3,1,35068);
insert into project_student values(4,3,35071);
...
Insert into faculty_project values(1,1,1);
Insert into faculty_project values(2,1,2);
Insert into faculty_project values(3,3,3);
Insert into faculty_project values(4,4,5);
